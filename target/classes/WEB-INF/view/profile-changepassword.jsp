...
<head>
    ...
    <!-- Main Font -->
    <script src="${pageContext.request.contextPath}/js/webfontloader.min.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/js/profile-changepassword.js"></script>
</head>
...
<body class="page-has-left-panels page-has-right-panels">
                        ...
                        <div class="row">
                            ...
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group label-floating is-empty">
                                    ...
                                    <input class="form-control" type="password" id="confirm_pass">
                                    <span class="material-input"></span></div>
                            </div>
                           ...
                           <%-- <div class="col col-lg-12 col-sm-12 col-sm-12 col-12">
                            ...
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <button class="btn btn-primary btn-lg full-width" onclick="saveChang()">Change Password Now!</button>
                            </div>
        ...
        <div class="col col-xl-3 order-xl-1 col-lg-3 order-lg-1 col-md-12 order-md-2 col-sm-12 col-12 responsive-display-none">
            <div class="ui-block">
                ...
                <div class="your-profile">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                                <ul class="your-profile-menu">
                                    <li>
                                        <a href="profile-personalinfo">Personal Information</a>
                                    </li>
                                    <li>
                                        <a>Change Password</a>
                                    </li>
                    ...
                    <div class="ui-block-title">
                        <a href="messages" class="h6 title">Messages</a>
                    </div>
                    <div class="ui-block-title">
    ...
    <!-- ... end  change password -->
<script src="${pageContext.request.contextPath}/js/profile-personalinfo.js"></script>
<script src="${pageContext.request.contextPath}/js/jquery-3.4.1.js"></script>
...
<script src="${pageContext.request.contextPath}/js/ion.rangeSlider.js"></script>

<script src="${pageContext.request.contextPath}/js/main.js"></script>
<script src="${pageContext.request.contextPath}/js/libs-init.js"></script>
