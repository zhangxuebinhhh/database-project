    ...
    var Comments = {
        ...
        getDefaultOptions: function() {
            return {
                ...
                textareaPlaceholderText: 'Add a message',
                newestText: 'Newest',
                oldestText: 'Oldest',
                popularText: 'Popular',
        ...
        init: function(options, el) {
            ...
            this.options.enableAttachments = false;
            // alert("options"+this.options.enableAttachments);
            // alert("editing"+this.options.enableEditing);
        ...
        postComment: function(ev) {
            ...
            var pid;
            if(sendButton.parents('li.comment').last().data()!=null){
                pid = sendButton.parents('li.comment').last().data().id;
            }else{
                pid = -1;
            }
            ...
            commentJSON.mid = pid;
            commentJSON.to_uid=$("#inputid").val();
            alert(commentJSON.to_uid);
            commentJSON.feed = $("#slId option:selected").text();
        ...
        createCommentingFieldElement: function(parentId, existingCommentId, isMain) {
            var self = this;
            //alert(parentId+" "+existingCommentId+" "+ isMain);
            // Commenting field
            ...
            //alert("existingComment ID"+existingCommentId);
            // Save button text
            if(existingCommentId) {
                ...
                //("sdsds"+this.options.enableAttachments);
            ...
            var sl = "      <select id=\"slId\" name=\"slId\" size=\"1\" >\n" +
                ...
                "       </select>"
            var inputid = "<input id=\"inputid\" type=\"text\"  name=\"inputid\" ></input>"
            controlRow.prepend(sl);
            controlRow.prepend(inputid);
